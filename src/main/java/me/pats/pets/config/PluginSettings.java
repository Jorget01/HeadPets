...
public final class PluginSettings {
    ...
    public PluginSettings(LanguageSettings language, MenuSettings menu, FollowSettings follow, ParticleSettings particles, EffectSettings effects) {
    ...
    public static PluginSettings load(Plugin plugin) {
        ...
        MenuSettings menu = new MenuSettings(showLocked);
        ...
        ParticleSettings particles = new ParticleSettings(enabled, vis, yOffset, perPetSelection, delayTicks, periodTicks, count, offX, offY, offZ, extra, options);
        ...
        return new PluginSettings(language, menu, follow, particles, effects);
    }

    public record LanguageSettings(I18n.LanguageMode mode, Language fixed, boolean allowPlayerOverride) {}

    public record MenuSettings(boolean showLockedInAll) {}
